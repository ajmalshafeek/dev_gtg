...
class Subscriptions_model extends CI_Model
{
    ...
    public function invoice_details($id)
    {
        ...
        $this->db->select('gtg_invoices.*,gtg_invoices.id AS iid,gtg_customers.*,gtg_customers.id AS cid,gtg_terms.id AS termid,gtg_terms.title AS termtit,gtg_terms.terms AS terms');
