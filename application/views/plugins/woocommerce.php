<article class="content">
    <div class="card card-block">
        ...
        <form method="post" id="data_form" class="form-horizontal">
            <div class="card card-block">
                ...
                <p>WooCommerce (WC) 2.6+ is fully integrated with the WordPress REST API. <br><span
                            class="text-primary">You can link your WooCommerce Store to . To create or manage keys for a specific WordPress user, go to WooCommerce > Settings >Advanced > REST API.</span>
                </p>
        ...
        <div class="card card-block">
            ...
            <p>You can import your woocommerce products to   with one click.</p>
        ...
        <div class="card card-block">
            ...
            <p>You can import your woocommerce orders to  with one click.</p>
