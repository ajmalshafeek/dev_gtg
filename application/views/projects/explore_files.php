                    ...
                    <div class="card-body">
                        <div class="card-block">
                            ...
                            <ul class="nav nav-tabs nav-justified">
                                <li class="nav-item">
                                    <a class="nav-link active" id="active-tab" data-toggle="tab" href="#active" aria-controls="active" aria-expanded="true">Summary</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="link-tab" data-toggle="tab" href="#link" aria-controls="link" aria-expanded="false">Tasks</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="thread-tab" data-toggle="tab" href="#thread" aria-controls="thread">Thread Mode</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="gtg_milestones-tab" data-toggle="tab" href="#milestones" aria-controls="milestones">Milestones</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="thread-tab" data-toggle="tab" href="#activities" aria-controls="activities">Activities</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="linkOpt-tab" data-toggle="tab" href="#files" aria-controls="files">Files</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="linkOpt-tab" data-toggle="tab" href="#notes" aria-controls="notes">Notes</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="invoices-tab" data-toggle="tab" href="#invoices" aria-controls="invoices">Invoices</a>
                                </li>
                            </ul>
                                            ...
                                            <li class="<?php if (!$flag) {
                                                ...
                                                <div class="timeline-panel">
                                                    <div class="timeline-heading">
                                                        <h4 class="timeline-title"><?php echo $row['name'] ?></h4>
                                                        <p>
                                                            <small class="text-muted"><i class="glyphicon glyphicon-time"></i> <?php echo $row['sdate'] . ' ~ ' . $row['edate'] ?>
                                                            </small>
                                                        </p>
                                                    </div>
                                                    <div class="timeline-body">
