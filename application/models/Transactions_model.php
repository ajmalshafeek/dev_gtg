...
class Transactions_model extends CI_Model
{
    ...
    {
        $this->db->select('gtg_transactions.*,gtg_transactions.id as id');
    ...
    public function addcat($name)
    {
        ...
        return $this->db->insert('gtg_trans_cat', $data);
    }
    ...
    public function addtrans($payer_id, $payer_name, $pay_acc, $date, $debit, $credit, $pay_type, $pay_cat, $paymethod, $note, $eid, $loc = 0, $ty = 0)
    {
        ...
        if ($pay_acc > 0) {
            ...
            if ($account) {
                ...
                return $this->db->insert('gtg_transactions', $data);
            }
        }
    }
    ...
    public function delt($id)
    {
        ...
        $this->db->delete('gtg_transactions', array('id' => $id));
    ...
    public function cat_update($id, $cat_name)
    {
        ...
        if ($this->db->update('gtg_trans_cat')) {
            return true;
        } else {
            return false;
        }
